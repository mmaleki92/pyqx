...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def createToolBarActions(self):
        ...
        for i in range(len(tools)):
            a = QtWidgets.QAction(
                QtGui.QIcon(
                    os.path.join("themes", self.context.theme, tools[i] + ".png")
                ),
    ...
    def createFileActions(self):
        ...
        for i in range(len(ids)):
            a = QtWidgets.QAction(
                ...
                self.context.getText("menu_file_labels", ids[i]),
                self,
            )
            a.setShortcut(shortcuts[i])
    ...
    def createEditActions(self):
        ...
        for i in range(len(ids)):
            a = QtWidgets.QAction(
                QtGui.QIcon("images/" + icons[i]),
                self.context.getText("menu_edit_labels", ids[i]),
                self,
            )
            a.setShortcut(shortcuts[i])
            a.triggered.connect(self.restoreFocus)
    ...
    def createViewActions(self):
        ...
        for i in range(len(ids)):
            a = QtWidgets.QAction(
                QtGui.QIcon("images/" + icons[i]),
                self.context.getText("menu_view_labels", ids[i]),
                self,
            )
            a.setShortcut(shortcuts[i])
            a.triggered.connect(self.restoreFocus)
    ...
    def createTransformActions(self):
        ...
        for i in range(len(ids)):
            a = QtWidgets.QAction(
                QtGui.QIcon("images/" + icons[i]),
                self.context.getText("menu_transform_labels", ids[i]),
                self,
            )
            a.setShortcut(shortcuts[i])
            a.triggered.connect(self.restoreFocus)
    ...
    def createHelpActions(self):
        ...
        for i in range(len(ids)):
            a = QtWidgets.QAction(
                QtGui.QIcon("images/" + icons[i]),
                self.context.getText("menu_help_labels", ids[i]),
                self,
            )
            a.setShortcut(shortcuts[i])
            a.triggered.connect(self.restoreFocus)
    ...
    def createDockWidgets(self):
        ...
        self.toolProperties.setSizePolicy(
            QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding
        )

        # Preview
        self.preview = Preview(
            self.context.getText("dock_widgets", "preview"),
            self.context,
            self.signals,
            self,
        )
    ...
    def openFile(self):
        ...
        fileName = QtWidgets.QFileDialog.getOpenFileName(
            ...
            + " (*.bmp *.gif *.png *.xpm *.jpg);;"
            + self.context.getText("dialog_open", "all_files")
            + " (*)",
        )
        if fileName:
    ...
    def mousePressEvent(self, event):
        ...
        if self.ctrlPressed:
            ...
            c = QtWidgets.QColor(
                im.pixel(QtWidgets.QCursor.pos())
    ...
    def closeEvent(self, event):
        ...
        for i in range(len(self.context.images)):
            if self.context.images[i].modified:
                l.append(i)
        ...
        if len(l) > 0:
            ...
            reply = QtWidgets.QMessageBox.warning(
                self,
                self.context.getText("dialog_exit", "title"),
