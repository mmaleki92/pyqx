...
class Context:
    ...
    def __init__(self, signals):
        ...
        self.pencilCur = QtGui.QCursor(
            QtGui.QPixmap("images/cursors/penicon.png"), 2, 17
        )
        self.colorPickerCur = QtGui.QCursor(
            QtGui.QPixmap("images/cursors/droppericon.png"), 2, 17
        )
        self.eraserCur = QtGui.QCursor(
            QtGui.QPixmap("images/cursors/erasericon.png"), 2, 17
        )
        self.fillCur = QtGui.QCursor(
            QtGui.QPixmap("images/cursors/fillicon.png"), 1, 14
        )
    ...
    def setDefault(self, sect, ident, value):
        ...
        try:
            ...
            print(
                ...
                + '" on section "'
                + sect
                + '", but given section does not exist. Creating section.'
            )
    ...
    def getDefault(self, sect, ident, default):
        ...
        try:
            ...
            print(
                'Trying to get value from option "'
                + ident
                + '" on section "'
                + sect
                + '", but no section with that name exists. Returning default value.'
            )
            return default
            ...
            print(
                ...
                + '" on section "'
                + sect
                + '", but specified option does not exist within that section. Returning default value.'
            )
            return default
    ...
    def getBoolDefault(self, sect, ident, default):
        ...
        try:
            ...
            print(
                'Trying to get boolean value from option "'
                + ident
                + '" on section "'
                + sect
                + '", but given option value is not boolean.'
            )
        except NoSectionError:
            print(
                'Trying to get boolean value from option "'
    ...
    def getIntDefault(self, sect, ident, default):
        ...
        try:
            ...
            print(
                'Trying to get integer value from option "'
                + ident
                + '" on section "'
                + sect
                + '", but given option value is not an integer.'
            )
        except NoSectionError:
            print(
                'Trying to get integer value from option "'
    ...
    def getFloatDefault(self, sect, ident, default):
        ...
        try:
            ...
            print(
                'Trying to get float value from option "'
                + ident
                + '" on section "'
                + sect
                + '", but given option value is not a floating point number.'
            )
        except NoSectionError:
            print(
                'Trying to get float value from option "'
    ...
    def loadDefaultsColor(self):
        ...
        self.primaryColor = QtGui.QColor(
            self.getIntDefault("color", "primary_color", QtCore.Qt.color1)
        )
        self.secondaryColor = QtGui.QColor(
            self.getIntDefault("color", "secondary_color", QtCore.Qt.color0)
        )
    ...
    def loadDefaultsSelection(self):
        ...
        self.transparentSelection = self.getBoolDefault(
    ...
    def loadDefaultsPencil(self):
        ...
        self.secondaryColorEraser = self.getBoolDefault(
            "pencil", "secondary_color_eraser", False
        )
