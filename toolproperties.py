...
class ToolProperties(QtWidgets.QDockWidget):
    ...
    def createSelectionWidget(self):
        ...
        transparent = QtWidgets.QCheckBox(
            self.context.getText("tool_properties_selection", "transparent"), self
        )
    ...
    def createPencilWidget(self):
        ...
        pencilSizeLabel = QtWidgets.QLabel(
            self.context.getText("tool_properties_pencil", "size")
        )
		...
		"""
        hbox2 = QtWidgets.QHBoxLayout()
        eraser = QtWidgets.QCheckBox(
            self.context.getText("tool_properties_pencil", "eraser"), self
        )
    ...
    def createEraserWidget(self):
        ...
        eraserSizeLabel = QtWidgets.QLabel(
            self.context.getText("tool_properties_eraser", "size")
        )
        slider = QtWidgets.QSlider(QtCore.Qt.Horizontal, self)
    ...
    def createGradientWidget(self):
        ...
        self.btn1 = QtWidgets.QRadioButton(
            self.context.getText("tool_properties_gradient", "horizontal")
        )
        self.btn2 = QtWidgets.QRadioButton(
            self.context.getText("tool_properties_gradient", "vertical")
        )
